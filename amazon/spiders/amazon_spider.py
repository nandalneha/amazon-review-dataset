...
class Amazon_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        url = getattr(self,'url','https://www.amazon.in/VOTO-V2I-2GB-32GBROM-Black/product-reviews/B075NLQWX2/ref=cm_cr_arp_d_paging_btm_2?ie=UTF8&reviewerType=all_reviews&pageNumber=2')
        #f = open(File)
        #urls = f.readlines()
